    ...
    <div v-if="!userLogin">
      ...
      <div v-else>
        ...
        <q-tab-panels v-model="step"
          ...
          <q-tab-panel name="input-password">
            <div class="titel q-mb-md">
              برای حساب کاربری خود یک کلمه‌ی عبور قرار دهید
            </div>
            <div class="set-password-inputs q-mb-md">
              <q-input ref="password"
                       ...
                       class="q-mb-md"
                       onfocus="this.removeAttribute('readonly');"
                       @keydown.enter="getEnter('checkPassword')" />
              <q-input ref="checkPassword"
  ...
  methods: {
    ...
    setPassword () {
      if (this.password !== this.checkPassword) {
        this.$q.notify({
          type: 'negative',
          message: 'تکرار کلمه عبور درست نیست.',
          position: 'top'
        })
        return
      }
